...
def restore_archive_job(
    ...
    # Legacy single-spanned-file dispatch retained temporarily
    # during shared tape-session integration.
    #
    # Spanned work now falls through to the common LTFS session
    # below so normal files and spanned parts can share one mount.
    if False and spanned_remaining:
